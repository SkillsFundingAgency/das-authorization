...
namespace SFA.DAS.Authorization.CommitmentPermissions.Context
{
    public static class AuthorizationContextExtensions
    {
        ...
        internal static (long CohortId, long ApprenticeshipId, Party Party, long PartyId) GetPermissionValues(this IAuthorizationContext authorizationContext)
        {
            ...
            {
                throw new KeyNotFoundException($"At least one key of '{AuthorizationContextKey.CohortId}' or '{AuthorizationContextKey.ApprenticeshipId}' should be present in the authorization context");
            }
