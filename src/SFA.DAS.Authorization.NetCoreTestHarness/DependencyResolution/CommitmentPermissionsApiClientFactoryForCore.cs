...
{
    public class CommitmentPermissionsApiClientFactoryForCore : CommitmentPermissionsApiClientFactory
    {
        public CommitmentPermissionsApiClientFactoryForCore() : base(GetConfig())
        {
        }
